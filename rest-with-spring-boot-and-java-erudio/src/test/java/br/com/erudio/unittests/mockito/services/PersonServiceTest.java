...
class PersonServiceTest {
	...
	void testFindById() {
		...
		/*
		 * Quando o repository.findById for chamado o mockito vai interceptar a chamada
		 * e retornará um optional do mock de person criado acima.
		 * 
	...
	void testFindAll() {
		...
		assertNotNull(personFive.toString().contains("links: [</api/person/v1/5>;rel=\"self\"]"));
		...
		assertNotNull(personTen.toString().contains("links: [</api/person/v1/10>;rel=\"self\"]"));
